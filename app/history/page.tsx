  ...
  return (
    <>
      <PageHero
        ...
        desc="Od pierwszych treningów w latach 2005. po dzisiejsze Martial Arts Academy. System, seminaria, doświadczenie i ludzie — to fundament, na którym rośnie nowa generacja zawodników."
        ...
        accent="gold"
        background={{imageSrc: "/placeholder/footer.webp", particles: true}}
        rightCard={{
          variant: "start",
          kicker: "DZIEDZICTWO",
